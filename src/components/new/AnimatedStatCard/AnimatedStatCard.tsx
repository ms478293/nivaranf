...
export const AnimatedStatCard: React.FC<AnimatedStatCardProps> = ({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col items-center justify-center p-6 rounded-lg transition-all duration-300 animate-in fade-in slide-in-from-bottom-4",
    ...
    >
      ...
      <div className="flex items-center justify-center gap-1">
        <span
          className={cn(
            "text-3xl sm:text-4xl lg:text-5xl font-bold transition-all duration-300",
