    ...
    >
      <div className="max-w-[1320px] mx-auto flex flex-col gap-4 py-4 md:py-16">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 mt-2">
          {/* Healthcare Card */}
          <div className="flex flex-col relative items-start border border-neutral-200 h-[350px] rounded-2xl overflow-hidden bg-white hover:shadow-md transition-shadow duration-300 hover:scale-[1.02] group">
            <div className="p-4 w-[60%] relative z-[10]">
              <h2 className="text-gray-800 text-xl font-semibold transition-colors duration-300 mb-2 group-hover:text-primary-500">
                Healthcare
              </h2>
