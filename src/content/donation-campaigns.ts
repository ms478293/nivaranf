...
export const DONATION_CAMPAIGNS: readonly DonationCampaign[] = [
  ...
  },
  {
    ...
    description: "Stand with communities affected by Nepal’s floods. Follow our plans for a response and the opening of this appeal.",
    formHeading: "Stand with Nepal.",
    formIntro: "This appeal is not accepting gifts yet. Nivaran has not deployed a flood response. We are preparing a dedicated fund with separate reporting.",
